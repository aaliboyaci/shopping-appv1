      ...
      <div class="user-page">{isLogin === 1 ?
        <div class="user-details">
          ...
          <div class="user-info">
            ...
            <br></br><br></br>
            <button className='clearCart' onClick={() => { setUser([]); setIsLogin(0) }}> Logout</button>
          </div></div> : <button className='goToCart' onClick={() => (setPage(1))}>Please Login first</button>}
